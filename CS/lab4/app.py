...
def app():
    ...
    R = st.text_input("Enter 32 characters for R (only '1' and '0'):", max_chars=32, value=st.session_state.fake_R)
    K = st.text_input("Enter 48 characters for K (only '1' and '0'):", max_chars=48, value=st.session_state.fake_K)
